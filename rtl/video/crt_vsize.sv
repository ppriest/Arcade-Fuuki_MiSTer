...
//  (rtl/Raiden/crt_vsize.sv). Author: Umberto Parisi (rmonic79), GPL v3 or
//  later, the same licence as this project. Do not edit locally: re-vendor
//  from upstream.
//
//  This core instantiates it with RING_LINES = 52 and LINE_PX = 320 (the
//  visible line), before crt_adjust, exactly as Raiden.sv does. 52 x 320 x
//  24 bits of ring is about 40 M10K.
//============================================================================
//============================================================================
