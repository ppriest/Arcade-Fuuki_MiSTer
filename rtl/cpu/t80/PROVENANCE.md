...
**In this repository:** copied on 2026-09-06 from the Psikyo core's `rtl/cpu/t80/`, unchanged.
FG-2's sound CPU is a Z80 at 6 MHz, driven through `T80se` with a clock enable exactly as
Psikyo's `sound_cpu.sv` does. The notes below are Psikyo's.
